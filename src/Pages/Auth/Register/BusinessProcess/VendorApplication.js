...
const VendorApplication = (props) => {
  ...
  return (
    <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}}>
      <h3 className="title-auth">1. Your Information</h3>
      ...
      <form onSubmit={onSubmit}>
        <div className="d-flex">
          <div className="mb-3 col-md-6 rm-padding-left">
            ...
            {fieldError.firstName && <div id="validationServer03Feedback" className="invalid-feedback mt-0 mb-0">Please provide a valid first name.</div>}
          </div>
